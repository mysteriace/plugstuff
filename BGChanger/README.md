...
|/move| A redudant command when using /keeppos, should any of the things you've move, move by themself using this command will readjust where all of them are located (Example, you move everything to where you like it and then you open the DJ history, everything will move back to their default positions, using this command will change everything back to how you set it up) |
